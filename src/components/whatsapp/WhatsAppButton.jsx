...
function WhatsAppButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 p-3 sm:p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-green-400/50 group"
      style={{ backgroundColor: "#25D366" }}
      aria-label="Chat on WhatsApp"
    >
      <FaWhatsapp className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: "#ffffff" }} />
